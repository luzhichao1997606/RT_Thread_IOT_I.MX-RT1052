...
#define DBI_START_ADDR  ((u32)(0X9C000000)) 				//DBI��ʼ��ַ(Ĭ�ϵ�ַ) 
#define DBI_SIZE_KBYTES ((u32)(64*1024))                    //DBI��С����λkBytes(Ĭ��32MB)
#define LCD_BASE        ((u32)(0X9C000000 | 0X0FFFE))		//��ַ��0X10000,�Ƕ�/д����,��ַ��0X10000�Ƕ�/дָ��,ע��:���λ����Ϊ1
