...
//电阻屏芯片连接引脚	   
#define PEN         GPIO_PinRead(GPIO3,4) //T_PEN
#define DOUT        GPIO_PinRead(GPIO1,8) //T_MISO
#define TDIN(n)     (n?GPIO_PinWrite(GPIO2,28,1):GPIO_PinWrite(GPIO2,28,0))//T_MOSI
#define TCLK(n)     (n?GPIO_PinWrite(GPIO2,29,1):GPIO_PinWrite(GPIO2,29,0))//T_SCK
#define TCS(n)      (n?GPIO_PinWrite(GPIO5,2,1):GPIO_PinWrite(GPIO5,2,0))  //T_CS  
