...
uint32_t UCGUI_LCD_CMD  = 0X6C000000; //��ַΪ0X6C000000; 
uint32_t UCGUI_LCD_DATA = 0X6C000800; //��ַΪ0x6C000800;  
/*********************************************************************
*
*       Defines
*
...
//	{
//		if(lcddev.id == 1)x=lcddev.width-1-x; //����ʱ����
//		//����X����
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setxcmd;
//		*(__IO uint16_t *)(UCGUI_LCD_DATA) = (x>>8); 
//		*(__IO uint16_t *)(UCGUI_LCD_DATA) = (x&0XFF);
...
//	{
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setxcmd; //����X����߰�λ
//		*(__IO uint16_t *)(UCGUI_LCD_DATA) = (x>>8); //x��ַ�ظ߰�λ
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setxcmd+1; //����X����Ͱ�λ
//		*(__IO uint16_t *)(UCGUI_LCD_DATA) = (x&0XFF);//x��ַ�Ͱ�λ
//		
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setycmd; //����y����߰�λ
//		*(__IO uint16_t *)(UCGUI_LCD_DATA) = (y>>8); //y��ַ�ظ߰�λ
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setycmd+1; //����y����Ͱ�λ
//		*(__IO uint16_t *)(UCGUI_LCD_DATA) = (y&0XFF);//y��ַ�Ͱ�λ
//	}else //������Ļ
//	{
...
//	*(__IO uint16_t *)(UCGUI_LCD_DATA) = PixelIndex;//��LCD��gramд����ɫֵ
}
...
//	u32 n;
//	if(lcddev.id == 0X9341 || lcddev.id == 0X5310 ||lcddev.id == 0X6804) //6804������֧�֣�������
//	{
//		//���ô��ڴ�С,X���������ʼ����ֹ����
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setxcmd; 
...
//		while(n--)
//		{
//			*(__IO uint16_t *)(UCGUI_LCD_DATA) = LCD_COLORINDEX;//��LCD��gramд����ɫֵ
//		}
//		
//		//�ָ����ڴ�С
//		*(__IO uint16_t *)(UCGUI_LCD_CMD)  = lcddev.setxcmd; 
